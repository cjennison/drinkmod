...
class RealProgressService {
  static RealProgressService? _instance;
  static RealProgressService get instance => _instance ??= RealProgressService._();
  
  RealProgressService._();
  
  final _drinkService = DrinkTrackingService.instance;

  /// Get real progress data for a goal using actual drink entries
  Future<Map<String, dynamic>> calculateRealGoalProgress(Map<String, dynamic> goalData) async {
